...
def test_args_logging(mock_tree, mock_log, mock_os, mock_sys, mock_logging):
    ...
    args_mock.return_value = Node(
        name="test", version=None, verbose=True, include="", exclude="", url="test_url", token="test_token", method=CloneMethod.SSH, file=None, concurrency=1, disble_progress=True, print=None, dest=".", insecure=False)
    cli.parse_args = args_mock
...
def test_args_include(mock_tree):
    ...
    args_mock = mock.Mock()
    args_mock.return_value = Node(
        name="test", version=None, debug=None, include=inc_groups, exclude=exc_groups, url="test_url", token="test_token", method=CloneMethod.SSH, file=None, concurrency=1, disble_progress=True, print=None, dest=".", insecure=False)
    cli.parse_args = args_mock
...
def test_args_include(mock_tree):
    args_mock = mock.Mock()
    args_mock.return_value = Node(
        name="test", version=None, verbose=None, include="", exclude="", url="test_url", token="test_token", method=CloneMethod.SSH, file=None, concurrency=1, disdisble_progress=True, print=True, dest=".", print_format=PrintFormat.YAML, insecure=False)
    cli.parse_args = args_mock
...
def test_empty_tree(mock_tree):
    args_mock = mock.Mock()
    args_mock.return_value = Node(
        name="test", version=None, verbose=None, include="", exclude="", url="test_url", token="test_token", method=CloneMethod.SSH, file=None, concurrency=1, disble_progress=True, print=True, dest=".", insecure=False)
    cli.parse_args = args_mock
